...
- [Backing Up Your Always Free VMs In The Oracle Cloud](https://recursive.codes/blog/post/98)
...
- [Connect your on-premises network using VPN](https://docs.oracle.com/en-us/iaas/Content/GSG/Tasks/loadbalancing.htm)
- [Configure cross-region private connectivity between tenancies](https://docs.oracle.com/en-us/iaas/Content/GSG/Tasks/loadbalancing.htm)
- [Video: DNS Zone Management](https://www.youtube.com/playlist?list=PLKCk3OyNwIzsx06b8pm0RLSCvFFBBcLm1)
- [Video: DNS Traffic Management Level 100](https://www.youtube.com/playlist?list=PLKCk3OyNwIzs7MlwhTHXCQ8AnQk8vEpJE)
- [Video: VCN Level 100](https://www.youtube.com/watch?v=ZryYNrxxZ48&list=PLKCk3OyNwIzsAjIaUaVsKdXcfBOy6LASv)
- [Video: Load Balancer Level 200](https://www.youtube.com/playlist?list=PLKCk3OyNwIzsJ_d4iI4nBhis5kE5g2eta)
...
- [Creating Active Directory Domain Services in Oracle Cloud Infrastructure](https://docs.oracle.com/en-us/iaas/Content/Resources/Assets/whitepapers/creating-active-directory-domain-services-in-oci.pdf)
- [Connecting to a Private IP Serial Console Through a Service Gateway](https://docs.oracle.com/en-us/iaas/Content/Resources/Assets/whitepapers/private-ip-serial-console-connection-via-service-gateway.pdf)
...
- [Protect Your Sensitive Data With Secrets In The Oracle Cloud](https://recursive.codes/blog/post/1384)
- [Free SSL Certificates In The Oracle Cloud Using CertBot And Let's Encrypt](https://recursive.codes/blog/post/110)
- [Automated Generation For OCI IAM Policies](https://recursive.codes/blog/post/1169)
...
- [Secure cloud workloads with Check Point CloudGuard Network Security](https://docs.oracle.com/en/solutions/secure-workloads-with-check-point-cloudguard/index.html)
- [Bastion With Load Balanced Apache Instances](https://enabling-cloud.github.io/oci-learning/manual/BastionWithLoadBalancedApache.html)
...
- [IPSec VPN Best Practices](https://docs.oracle.com/en-us/iaas/Content/Resources/Assets/whitepapers/ipsec-vpn-best-practices.pdf)
- [Encrypted FastConnect: Public Peering](https://docs.oracle.com/en-us/iaas/Content/Resources/Assets/whitepapers/encrypted-fastconnect-public-peering.pdf)
- [Bastion Hosts: Protected Access for Virtual Cloud Networks](https://docs.oracle.com/en-us/iaas/Content/Resources/Assets/whitepapers/bastion-hosts.pdf)
- [How to Quantify the Value of a CASB](http://www.oracle.com/us/solutions/cloud/platform-as-a-service/quanitify-value-of-casb-wp-3497489.pdf)
- [The Importance of User Behavior Analytics for Cloud Service Security](http://www.oracle.com/us/solutions/cloud/platform-as-a-service/user-behavior-analytics-3497541.pdf)
- [Hiding in Plain Sight: How a CASB with Built-In UBA Unmasks Insider Threats in the Cloud](http://www.oracle.com/us/solutions/cloud/platform-as-a-service/hiding-in-plain-sight-wp-3497542.pdf)
- [Best Practices for Identity and Access Management (IAM) in Oracle Cloud Infrastructure](https://docs.oracle.com/en-us/iaas/Content/Resources/Assets/whitepapers/best-practices-for-iam-on-oci.pdf)
- [Deploying Oracle Audit Vault and Database Firewall in Oracle Cloud Infrastructure](https://docs.oracle.com/en-us/iaas/Content/Resources/Assets/whitepapers/deploy-avdf-in-oci.pdf)
- [Managing Oracle Database Encryption Keys in Oracle Cloud Infrastructure with Oracle Key Vault](https://docs.oracle.com/en-us/iaas/Content/Resources/Assets/whitepapers/manage-encryption-keys-oci-okv.pdf)
...
- [Live Labs: OCI Configuring Auto Scaling](https://apexapps.oracle.com/pls/apex/dbpm/r/livelabs/view-workshop?wid=597&session=101797632958623)
...
- [Deploy Commvault to protect your VMware SDDC in the cloud against disasters](https://docs.oracle.com/en/solutions/deploy-commvault-for-ocvs/index.html)
...
- [Deploy a cross-region disaster recovery solution using Rackware](https://docs.oracle.com/en/solutions/deploy-xreg-dr-rackware/index.html)
