...
- [Migrate an IBM Netezza data warehouse appliance to Oracle Autonomous Data Warehouse](https://docs.oracle.com/en/solutions/migrate-netezza/index.html#GUID-ABA571CA-5D09-4F81-8169-F0A09BD58879)
- [Migrating Teradata and Netezza to Oracle Autonomous Database](https://blogs.oracle.com/cloud-infrastructure/migrating-teradata-and-netezza-to-oracle-autonomous-database)
- [Migrate an on-premises Oracle Database deployment to an autonomous database](https://docs.oracle.com/en/solutions/migrate-to-atp/index.html#GUID-65DDD4A1-5E6C-406C-9689-74BC026C8DA2)
